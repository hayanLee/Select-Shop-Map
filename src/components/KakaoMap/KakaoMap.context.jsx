  ...
  const createNewMarkers = () => {
    if (mapInstance && places.length) {
      ...
      places.forEach((place) => {
        const markerPosition = new window.kakao.maps.LatLng(place.y, place.x); // 위치를 찾아서
        ...
        const content = `
          <div style="padding:16px; background-color:white; border:1px solid #d1d5db; border-radius:12px; max-width:400px; box-shadow:0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <img src="src/assets/mainIcon.png" alt="${place.place_name}" style="margin-bottom:8px; width:100%; height:100%; display:flex; border-radius:8px; "/>
