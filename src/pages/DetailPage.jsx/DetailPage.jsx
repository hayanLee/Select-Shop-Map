  ...
  return (
    <div className="flex min-h-screen justify-center">
      <main className="w-full max-w-[1320px] p-4">
        <div className="flex space-x-6 rounded-lg bg-hover p-[48px_36px_30px_36px] shadow-lg">
          <img
            // src={require('../assets/image.jpg')} // 실제 이미지 경로로 변경
            alt="Store"
            className="h-64 w-1/2 rounded-lg bg-white object-cover"
          />
          <div className="relative w-1/2 rounded-lg bg-white p-6">
        ...
        <div className="mt-6 rounded-lg bg-hover p-[48px_36px_30px_36px]">
